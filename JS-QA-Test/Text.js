...
a truthy value is a value that is treated as true when used in a Boolean context.
...
hoisting is a JavaScript behavior where declarations are processed before the code is executed.
eg.greet();
function greet() {
  console.log("Hello");
}
...
this refers to the object associated with the current execution context. Its value depends on how a function is called.
const person = {
  name: "John",
  greet: function() {
